          ...
          <div className="space-y-3">
            {allAlerts.map((alert) => (
              <Link key={alert.alert_id} href={`/physician/alerts/${alert.alert_id}`}>
                <div className={cn("bg-white rounded-2xl p-4 border hover:shadow-sm transition-all flex items-center gap-4 group", !alert.acknowledged_at ? "border-red-100 hover:border-red-300" : "border-slate-100 hover:border-slate-200")}>
