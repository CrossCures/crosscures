"""CrossCures v2 FastAPI Application."""
from fastapi import FastAPI, Request
from fastapi.middleware.cors import CORSMiddleware
from fastapi.responses import JSONResponse

from crosscures_v2.database import init_db
from crosscures_v2.config import get_settings
from crosscures_v2.api.users import router as users_router
...
async def global_exception_handler(request: Request, exc: Exception):
    from crosscures_v2.consent.models import ConsentError
...
def main():
    import uvicorn
    uvicorn.run("crosscures_v2.app:app", host="0.0.0.0", port=8000, reload=True)
